...
import za.ca.cput.assignment5kaylin.service.churchAdmin.implementation.PledgeServiceImplementation;
...
public class PledgeServiceImplementationTest
{
	@Autowired
	private PledgeServiceImplementation service;
	private List<Pledge> classes;
	Pledge cl;
	Pledge c2;
	...
	public void l_create()
	{
		...
		Pledge c = this.service.create(cl);
		Assert.assertEquals(cl.getPledgeNum(), c.getPledgeNum());
		Pledge cc = this.service.create(c2);
		Assert.assertEquals(c2.getPledgeNum(), cc.getPledgeNum());
	}
	...
	public void n_update()
	{
		...
		Pledge c = this.service.update(cl);
		Assert.assertEquals(cl.getPledgeNum(), c.getPledgeNum());
